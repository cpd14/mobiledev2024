...
public class WeatherAndForecastFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Load WeatherFragment into its container
        getChildFragmentManager().beginTransaction()
                .replace(R.id.weather_fragment_container, new WeatherFragment())
                .commit();

        // Load ForecastFragment into its container
        getChildFragmentManager().beginTransaction()
                .replace(R.id.forecast_fragment_container, new ForecastFragment())
                .commit();
    }
}
